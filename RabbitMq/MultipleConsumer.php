...
class MultipleConsumer extends Consumer
{
    ...
    protected function setupConsumer()
    {
        ...
        foreach ($this->queues as $name => $options) {
            ...
            $this->getChannel()->basic_consume($name, $this->getQueueConsumerTag($name), false, $this->consumerOptions['auto_ack'], false, false, function (AMQPMessage $msg) use($currentObject, $name) {
